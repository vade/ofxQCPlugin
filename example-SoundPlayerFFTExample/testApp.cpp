...
//--------------------------------------------------------------
void soundPlayerFFTTestApp::setup(){	 

	// load in sounds:
	beat.loadSound("jdee_beat.mp3");
	ow.loadSound("ow.mp3");	
...
//--------------------------------------------------------------
void soundPlayerFFTTestApp::update(){
...
//--------------------------------------------------------------
void soundPlayerFFTTestApp::draw(){
...
//--------------------------------------------------------------
void soundPlayerFFTTestApp::keyPressed  (int key){ 
}

//--------------------------------------------------------------
void soundPlayerFFTTestApp::keyReleased(int key){ 
	
}

//--------------------------------------------------------------
void soundPlayerFFTTestApp::mouseMoved(int x, int y ){
	
}

//--------------------------------------------------------------
void soundPlayerFFTTestApp::mouseDragged(int x, int y, int button){
...
//--------------------------------------------------------------
void soundPlayerFFTTestApp::mousePressed(int x, int y, int button){
	prevx = x;
	prevy = y;
}

//--------------------------------------------------------------
void soundPlayerFFTTestApp::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void soundPlayerFFTTestApp::windowResized(int w, int h){
